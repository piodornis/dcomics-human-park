...
## Arbeitsfassung v0.3 · Repo-Übernahme · 14. September 2026

| Feld | Festlegung |
|---|---|
| Style ID | human-park-earth |
| Stilfamilie | Konturbetonter, farbiger Industrie-Comic |
| Designstatus dieses Leitfadens | EXPLORATION; drei Gestaltungsregeln ausdrücklich APPROVED, siehe Abstimmung |
...
Der Autor hat die folgenden drei Gestaltungsregeln im Gespräch ausdrücklich angenommen. Diese Regeln sind für die weitere Earth-Entwicklung APPROVED. Die vier Bildreferenzen bleiben SELECTED; übrige Regelvorschläge und Ortsdetails werden dadurch nicht pauschal freigegeben. Zustimmung und Bildauswahl sind mit dieser Fassung im Projekt-Repo dokumentiert. Das Repo `dcomics-human-park` bleibt die Source of Truth.

## Abstimmung — drei angenommene Earth-Gestaltungsregeln

**G-01 · Alter durch Reparaturgeschichte — APPROVED.** Alte Gehäuse, jüngere Abdeckungen und mehrfach ersetzte Bauteile sollen unterscheidbar sein. Pflege und lange Betriebsdauer werden über nachvollziehbare Eingriffe sichtbar. Rost und Abnutzung werden gezielt verteilt. Am ausgewählten Wartungsbild ist keine automatische Bildkorrektur vorgenommen worden; neue Entwürfe sollen die Materialgenerationen deutlicher trennen.

**G-02 · Erkennbare Technik mit gewachsenen Umbauten — APPROVED.** Vertraute Grundformen von Kraftwerken, Windrädern und Serviceschränken dürfen bestehen bleiben. Ersatzteile verschiedener Generationen und nachträgliche Umbauten geben ihnen ihre Human-Park-Identität. Konkrete Jahreszahlen, Hersteller oder neue technische Fähigkeiten werden daraus nicht abgeleitet.

**G-03 · Gezielte Detaildichte — APPROVED.** Rechenzentrum B bleibt die visuelle Grundlage. Reparaturstellen und wichtige Anschlüsse erhalten viele Details; große Flächen und entfernte Bereiche bleiben ruhiger. Maßstab und räumliche Lesbarkeit haben Vorrang vor zusätzlicher Ausstattung.

**Geltungsbereich:** Earth-Umgebungsentwicklung dieses Projekts. Keine globale Freigabe des Human-Park-Stils, keine Änderung der Charakterdesigns, kein LOCKED-Status und keine Freigabe finaler Panels.

**Weiter offen:** Zugangsgeschichte und Raumfolge der Fundanlage. Die Zustimmung zu G-01 bis G-03 ändert keine narrativen Statusangaben.

**Entscheidungsnachweis:** Der Assistent schlug ausdrücklich vor, diese drei Punkte als Earth-Gestaltungsregeln zu übernehmen und Zugangsgeschichte sowie Raumfolge offen zu lassen. Der Autor bestätigte: „Ja, gerne.“

## 1. Die vier ausgewählten Referenzen

### E-01 · Rechenzentrum B — SELECTED

![Rechenzentrum B](../../environments/earth/references/style-exploration/earth-b-detailreich.png)
...
![Energieversorgung V4](../../environments/earth/references/energy-exploration/earth-energie-im-eis-v4.png)
...
![Wartungsbereich V1](../../environments/earth/references/maintenance-exploration/earth-wartungsbereich-v1.png)
...
![Zugang V2](../../environments/earth-discovery-facility/references/access/earth-fundanlage-zugang-v2.png)
...
- **CANON:** Eine frühere sechste Kryokammer fehlt beim Fund. Inhalt, Verbleib und Figurenwissen bleiben OPEN; fünf vorhandene Kammern werden transportiert.
...
## 3. Operative Gestaltungsregeln — abgestimmter Kern und ergänzende Vorschläge

G-01 bis G-03 oben sind angenommen. Die folgenden Detailformulierungen operationalisieren sie; darüber hinausgehende Vorgaben bleiben Regelvorschläge.
...
| Formen | Robuste Gehäuse, verständliche Öffnungen, klare Träger und Verbindungspunkte. Vertraute technische Grundformen mit nachträglichen Umbauten verbinden (G-02). Runde Ecken und rechteckige Austauschplatten dürfen unterschiedliche Bauphasen ausdrücken. |
| Metall | Lackabrieb an Kanten und Griffstellen; Korrosion an plausiblen Fugen. Alte Gehäuse, jüngere Abdeckungen und mehrfach ersetzte Befestigungen gezielt unterscheidbar machen; technisch kompatibel halten (G-01). |
...
| Detail | Höchste Dichte am erzählerisch wichtigen Bauteil, mittlere Dichte im Nahraum, vereinfachte Fernformen. Ruhige große Flächen zwischen den Detailgruppen erhalten; wichtige Reparaturstellen priorisieren (G-03). |
...
| Kryoraum | Fünf jüngere Kammern und eine fehlende frühere sechste Kammer sind vorgegeben; Aussehen, Anordnung und Spuren bleiben Vorschläge | Environment Designer mit Story-Constraints |
...
**Comic Style Director:** G-01 bis G-03 sind für Earth angenommen und bei neuen Entwürfen anzuwenden. Weiterführende Detailregeln und zusätzliche Motive bleiben prüfbar. Die ausgewählten Bilder werden durch die Regelabstimmung nicht automatisch neu generiert.

**Comic Environment Designer:** [Raumkonzept V2](../../environments/earth-discovery-facility/references/plan/raumkonzept-v2.md) weiter abstimmen. Zugang → technische Vorzone → Hauptweg → Kryoraum, mit seitlich angeschlossener Wartung, ist der aktuelle Vorschlag, noch kein bestätigter Grundriss. Schwellen, Türen, Durchgangsbreiten und relevante Sichtachsen zuerst klären; daraus zusammenhängende Ansichten ableiten.
...
## 7. Ablage und Versionsgeschichte

- [Earth-Designrecord](../../environments/earth/design.md): Referenzrollen und Auswahl.
- [Fundanlagen-Designrecord](../../environments/earth-discovery-facility/design.md): Zugang und Raumkonzept.
- [V0.2](history/earth-stilleitfaden-v0.2.md) und [V0.1](history/earth-stilleitfaden-v0.1.md): frühere Fassungen.

V0.3 übernimmt die drei bereits angenommenen Regeln unverändert, ergänzt die sechste Kammer als narrative Grenze und verknüpft den inzwischen übernommenen Raumvorschlag. Keine zusätzliche Stilfreigabe.
...
Diese Fassung ist im Projekt-Repo abgelegt. Nur G-01 bis G-03 sind ausdrücklich APPROVED für Earth; keine pauschale Freigabe des restlichen Dokuments.
