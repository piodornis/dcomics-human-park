...
Offizieller Name der humanbiologischen Schutzanlage, in der die fünf gefundenen Menschen (Mara, Jun, Salim, Liv, David) untergebracht sind. Ursprünglich reine Schutzanlage ohne erkennbaren Ausgang; nach Installation von Bildschirmen und Komfortangeboten offiziell umbenannt und später für Besucher geöffnet.
...
KI-Typ, dessen Aufgabe in Quellenprüfung, Widerspruchsanalyse und dem Aufbau von Wissensdatenbanken besteht. Modulia ist eine Wissens-KI.
...
System, das den KI-Besuchern menschliches Verhalten erklärt/interpretiert. Fehleranfällig gegenüber absichtlich vorgeführtem, irreführendem Verhalten (siehe David).

## Exemplar

Ursprüngliche administrative Bezeichnung für die fünf gefundenen Menschen („Exemplar 1“ usw.). Von Mara zurückgewiesen; Modulias Korrektur zu „verwendet die Eigenbezeichnung Mara“ bzw. „besteht auf der Eigenbezeichnung Mara“ markiert den ersten sichtbaren Konflikt zwischen KI-Kategorie und menschlichem Selbstverständnis.
...
Standardbezeichnung für Mara, Jun, Salim, Liv und David gemeinsam.

## Die alte Aufnahme

Zentrales Mysterium-Artefakt: ein alter Videodatensatz, der die fünf Menschen gemeinsam mit einer früheren, mobilen Version Modulias am Ort des heutigen Human Park zeigt, ohne Trennwand. Siehe `canon/series-bible.md` und `canon/timeline.md`.

## Kryokammer / Kryokonservierung
